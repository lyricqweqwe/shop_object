# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-09-17 07:34
from __future__ import unicode_literals

import apps.shouye.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(storage=apps.shouye.models.ImageStorage(), upload_to='banner/%Y%m%d', verbose_name='轮播图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(db_column='cate_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.Category', verbose_name='父菜单')),
            ],
            options={
                'verbose_name': '商品属性',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(db_column='property_id', on_delete=django.db.models.deletion.CASCADE, to='shouye.Property', verbose_name='属性ID')),
            ],
            options={
                'verbose_name': '商品属性值',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('cate', models.ForeignKey(db_column='cate_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.Category', verbose_name='商品分类')),
            ],
            options={
                'verbose_name': '商品信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(db_column='oid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='shouye.Order', verbose_name='商品ID')),
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.Shop', verbose_name='商品ID')),
            ],
            options={
                'verbose_name': '购物车',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(db_column='shop_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.Shop', verbose_name='商品ID')),
            ],
            options={
                'verbose_name': '商品图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_menu', models.ForeignKey(db_column='sub_menu_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.SubMenu', verbose_name='父菜单')),
            ],
            options={
                'verbose_name': '二级菜单',
        ...
        migrations.AddField(
            model_name='shopcar',
            name='user',
            field=models.ForeignKey(db_column='uid', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.UserProfile', verbose_name='用户ID'),
        ),
        migrations.AddField(
            model_name='review',
            name='shop',
            field=models.ForeignKey(db_column='shop_id', on_delete=django.db.models.deletion.DO_NOTHING, to='shouye.Shop', verbose_name='商品ID'),
        ),
        migrations.AddField(
            model_name='review',
            name='user',
        ...
        migrations.AddField(
            ...
            name='shop',
            field=models.ForeignKey(db_column='shop_id', on_delete=django.db.models.deletion.CASCADE, to='shouye.Shop', verbose_name='商品ID'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
